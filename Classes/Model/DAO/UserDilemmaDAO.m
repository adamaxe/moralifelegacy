...
- (NSArray *)retrievePersistedObjects {	
	...
	NSEntityDescription *entityAssetDesc = [NSEntityDescription entityForName:@"UserDilemma" inManagedObjectContext:self.context];
