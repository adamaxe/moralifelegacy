...
//	CGContextFillEllipseInRect(context, CGRectMake(12, 12, 165, 165));
    ...
    /** @todo ensure that only one bubbletype is assigned */
    //Star
    ...
    //Round
    if ((bubbleType == kBubbleTypeRoundNormal) || (bubbleType == kBubbleTypeRoundShort) || (bubbleType == kBubbleTypeRoundTall) || (!isBubbleSelected)){
