...
int const MLConscienceLowerLeftXIntro = 55;
int const MLConscienceLowerLeftYIntro = 420;
int const MLConscienceHomeX = 80;
int const MLConscienceHomeY = 80;
int const MLConscienceIntroX = 120;
int const MLConscienceIntroY = 300;
int const MLConscienceOffscreenBottomX = 55;
int const MLConscienceOffscreenBottomY = 580;
